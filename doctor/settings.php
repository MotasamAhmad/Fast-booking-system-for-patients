...
<body>
    ...
    $userrow = mysqli_query($database, "SELECT * FROM doctor WHERE docemail='$useremail'");
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="30%" style="padding-left: 20px;">
                                    <?php
                                     $profileImagePath = $userfetch['doctor_img_path'];

                                     echo '<div style="width: 100px; height: 100px; border-radius: 50%; overflow: hidden;">
                                               <img src="../img/'.$profileImagePath.'" alt="Doctor Image" style="width: 100%; height: 100%; object-fit: cover;">
                                           </div>';
                                     ?>
                                </td>
            ...
            <tr>
                ...
                <td width="15%">
                    ...
                    <?php 
                        ...
                        $patientrow = mysqli_query($database, "SELECT * FROM patient;");
                        $doctorrow = mysqli_query($database, "SELECT * FROM doctor;");
                        $appointmentrow = mysqli_query($database, "SELECT * FROM appointment WHERE appodate>='$today';");
                        $schedulerow = mysqli_query($database, "SELECT * FROM schedule WHERE scheduledate='$today';");
                    ?>
                            ...
                            <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        <img src="'.$profileImagePath.'" alt="Profile Image" style="border-radius: 50%; width: 150px; height: 150px;"><br><br>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <div style="display: flex;justify-content: center;">
                                    <div class="abc">
                                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Doctor Details. Doctor ID : ' . $id . ' (Auto Generated)<br><br></td>
                                            </tr>
                                            <tr>
                                                <td class="label-td" colspan="2">
