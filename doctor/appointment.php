...
<body>
    ...
    if(isset($_SESSION["user"])){
       ...
       $userresult = mysqli_query($database, "SELECT * FROM doctor WHERE docemail='$useremail'");
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    ...
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">My
                        Appointments (<?php echo mysqli_num_rows($list110); ?>)</p>
                </td>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    $list11 = mysqli_query($database, "SELECT * FROM doctor");
