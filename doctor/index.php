                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="30%" style="padding-left: 20px;">
                                    <?php
                                     // Assuming $userfetch contains the doctor's information including the image path
                                     $profileImagePath = $userfetch['doctor_img_path']; // Adjust this to the actual column name in your database
