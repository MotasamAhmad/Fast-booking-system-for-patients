                ...
                <td width="15%">
                    ...
                    <p class="heading-sub12" style="padding: 0;margin: 0;">
                        <?php 
                                ...
                                $patientresult = mysqli_query($database, "SELECT * FROM patient");
                                $patientrow = mysqli_num_rows($patientresult);
                            
                                $doctorresult = mysqli_query($database, "SELECT * FROM doctor");
                                $doctorrow = mysqli_num_rows($doctorresult);
                            
                                $appointmentresult = mysqli_query($database, "SELECT * FROM appointment WHERE appodate>='$today'");
                                $appointmentrow = mysqli_num_rows($appointmentresult);
                            
                                $scheduleresult = mysqli_query($database, "SELECT * FROM schedule WHERE scheduledate='$today'");
                                $schedulerow = mysqli_num_rows($scheduleresult);
                                    ...
                                    <form action="schedule.php" method="post" style="display: flex">
                                        ...
                                        <input type="search" name="search" class="input-text "
                                            ...
                                            <?php
                                              ...
                                              $list11_result = mysqli_query($database, "SELECT docname, docemail FROM doctor;");
                                              
                                              while ($row00 = mysqli_fetch_assoc($list11_result)) {
                                                  $d = $row00["docname"];
