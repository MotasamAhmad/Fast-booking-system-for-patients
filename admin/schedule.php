            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Sessions (<?php echo mysqli_num_rows($list110);?>)</p>
                    </td>
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <select name="docid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            ...
                            $list11 = mysqli_query($database, "SELECT docname, docid FROM doctor ORDER BY docname ASC");
                                 ...
                                 $result = mysqli_query($database, $sqlmain);
                                   ...
                                   if(mysqli_num_rows($result) == 0){
                                       ...
                                       while ($row = mysqli_fetch_assoc($result)) {
                                           ...
                                           $sqlCountPatients = "SELECT COUNT(appointment.appoid) AS total_patients FROM appointment  WHERE appointment.scheduleid = $scheduleid";
                                           $resultCountPatients = mysqli_query($database, $sqlCountPatients);
                                           $rowCountPatients = mysqli_fetch_assoc($resultCountPatients);
                                           $total_patients = $rowCountPatients['total_patients'];
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            '; 
             ...
             $result12 = mysqli_query($database, $sqlmain12);
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <td colspan="4">
                                <center>
                                 ...
                                 $result = mysqli_query($database, $sqlmain12);
