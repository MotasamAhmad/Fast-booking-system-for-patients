        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <td width="15%">
                    ...
                    <p class="heading-sub12" style="padding: 0;margin: 0;">
                        <?php
                         ...
                         $list110 = mysqli_query($database, "SELECT * FROM appointment");
                        ?>
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Appointments (<?php echo mysqli_num_rows($list110); ?>)</p>
                </td>
                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <select name="docid" id="" class="box filter-container-items"
                                        ...
                                        <?php 
                                            $query = mysqli_query($database, "SELECT * FROM doctor ORDER BY docname ASC;");
                                        
                                            while ($row00 = mysqli_fetch_assoc($query)) {
                                                $sn = $row00["docname"];
                                                $id00 = $row00["docid"];
