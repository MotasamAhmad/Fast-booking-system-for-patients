...
<body>
    ...
    <div class="container">
        <div class="menu" style=" background:#edf6ff ">
                ...
                <td>
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        <?php
                                ...
                                $list11 = mysqli_query($database, "SELECT docname, docemail FROM doctor;");
                                
                                for ($y = 0; $y < mysqli_num_rows($list11); $y++) {
            ...
            <tr>
                ...
                <td colspan="2">
                    <a href="?action=add&id=none&error=0" class="non-style-link"><button
                            ...
                            style="display: flex;justify-content: center;align-items: center;margin-left:75px;background-image: url('../img/icons/add.svg');">Add New</font></button>
                    </a>
                </td>
            </tr>
            <tr>
                <td colspan="4" style="padding-top:10px;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Doctors (<?php echo mysqli_num_rows($list11); ?>)</p>
                </td>
                    ...
                    <center>
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0">
                                <thead>
                                    <tr>
                                        <th class="table-headin">Doctor Info</th>
                        ...
                        if(mysqli_num_rows($result) == 0){
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                $email = $row["docemail"];
                                $spe = $row["specialties"];
                                $spcil_res = mysqli_query($database, "SELECT sname FROM specialties WHERE id='$spe'");
                                $spcil_array = mysqli_fetch_assoc($spcil_res);
                                $spcil_name = $spcil_array["sname"];
                        
                                $profileImagePath = "../img/doc/" . $row["doctor_img_path"];
                        
                                echo '<tr>
                                        <td>
                                            <div style="display: flex; align-items: center;">
                                                <img src="'.$profileImagePath.'" alt="Doctor Image" style="border-radius: 50%; width: 40px; height: 40px;">
                                                <span style="margin-left: 10px;">'.substr($name, 0, 30).'</span>
                                            </div>
                                        </td>
                            ...
                            <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        <img src="'.$profileImagePath.'" alt="Profile Image" style="border-radius: 50%; width: 100px; height: 100px;"><br><br>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    $list11 = mysqli_query($database, "SELECT * FROM specialties ORDER BY sname ASC");

                                    while ($row00 = mysqli_fetch_assoc($list11)) {
                                        $sn = $row00["sname"];
                                        $id00 = $row00["id"];
                        ...
                        echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <input type="file" name="profile_image" id="profile_image" class="input-text" accept="image/*">
                                </td>
                            </tr>       
                            <tr>
                                <td colspan="2">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            ...
                                            $list11 = mysqli_query($database, "SELECT * FROM specialties");
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                         <td class="label-td" colspan="2">
                                             <input type="file" name="profile_image" class="input-text""><br>
                                         </td>
                                     </tr>
